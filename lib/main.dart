...
Future<void> main() async {
  ...
  _audioHandler = await AudioService.init(
    ...
    config: const AudioServiceConfig(
      androidNotificationChannelId: 'org.applogiq.musiq.channel.audio',
      androidNotificationChannelName: 'Audio playback',
      androidNotificationOngoing: true,
    ),
  );
...
class MainScreenAudio extends StatelessWidget {
  const MainScreenAudio({Key? key}) : super(key: key);
...
class AudioPlayerHandler extends BaseAudioHandler with SeekHandler {
  static final _item = [
    ...
    MediaItem(
      id: 'https://api-musiq.applogiq.org/api/v1/audio?song_id=${"2"}',
      album: "Science Friday",
      title: "A Salute To Head-Scratching Science",
      artist: "Science Friday and WNYC Studios",
      duration: const Duration(milliseconds: 5739820),
