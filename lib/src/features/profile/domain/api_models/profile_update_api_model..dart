class ProfileApi {
    ...
    factory ProfileApi.fromJson(Map<String, dynamic> json){ 
        ...
        records: json["records"] == null ? null : Records.fromJson(json["records"]),
    );
    }
...
class Records {
    ...
    factory Records.fromJson(Map<String, dynamic> json){ 
        ...
        preference: json["preference"] == null ? null : Preference.fromJson(json["preference"]),
...
class Preference {
    ...
    factory Preference.fromJson(Map<String, dynamic> json){ 
        return Preference(
        artist: json["artist"] == null ? [] : List<String>.from(json["artist"]!.map((x) => x)),
    );
    }
