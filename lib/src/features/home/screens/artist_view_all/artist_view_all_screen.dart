                      ...
                      child: GridView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          return GestureDetector(
                            onTap: () {
                              Navigation.navigateToScreen(context,
                                  RouteName.artistViewAllSongListScreen,
                                  args: ArtistViewAllModel(
                                      id: pro.artistModel.records[index].id
                                          .toString(),
                                      artistId: pro
                            ...
                            child: Column(
                              ...
                              children: [
                                (pro.artistModel.records[index].isImage ==
                                            false ||
                                    ...
                                    : CustomColorContainer(
                                        child: Image.network(
                                        generateArtistImageUrl(pro.artistModel
