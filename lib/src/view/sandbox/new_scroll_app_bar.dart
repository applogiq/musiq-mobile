        ...
        return SafeArea(
          child: Scaffold(
            ...
            headerSliverBuilder: (BuildContext context, bool innerBoxIsScrolled) {
              return <Widget>[
              SliverAppBar(
                bottom: PreferredSize(preferredSize: Size(MediaQuery.of(context).size.width,80),
                child: SecondaryAppBar(title: "D"),
                ),
                expandedHeight: 300.0,
                pinned: true,
               leadingWidth: 0.0, leading: EmptyBox(),
                floating: true,
                excludeHeaderSemantics: true,
                 flexibleSpace: FlexibleSpaceBar(
                    centerTitle: true,
                    title: PrimaryAppBar(isNetworkImage: true, imageURL:  'https://images.squarespace-cdn.com/content/5aee389b3c3a531e6245ae76/1530965251082-9L40PL9QH6PATNQ93LUK/linkedinPortraits_DwayneBrown08.jpg?format=1000w&content-type=image%2Fjpeg', title: "title", height: 250.0, count: 3)
