...
class Record {
    ...
    factory Record.fromMap(Map<String, dynamic> json) => Record(
        playlistSongs: json["playlist_songs"] == null ? null : PlaylistSongs.fromMap(json["playlist_songs"]),
    ...
    Map<String, dynamic> toMap() => {
        ...
        "music_director_name": musicDirectorName == null ? null : List<dynamic>.from(musicDirectorName!.map((x) => x)),
